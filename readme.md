...
If the API is't working, go to this link https://aistudio.google.com/app/api-keys and generate a API key for yourslef, then replace the API key with your's in line 8 of the code.
