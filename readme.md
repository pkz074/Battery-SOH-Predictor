...
Gemini auto dectes API leaks, so go to this link https://aistudio.google.com/app/api-keys and generate a API key for yourslef, then replace the API key with your's in line 18 of the code.
